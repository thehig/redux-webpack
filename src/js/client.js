...
const actions = {
    "FETCH_USERS_PENDING": (state, payload)=> { return {...state, fetching: true}; }
    , "FETCH_USERS_FULFILLED": (state, payload)=> { return {...state, fetching: false, users: payload}; }
    , "FETCH_USERS_REJECTED": (state, payload)=> { return {...state, fetching: false, error: payload}; }
};
